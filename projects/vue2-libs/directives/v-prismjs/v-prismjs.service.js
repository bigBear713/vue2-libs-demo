...
const VPrismjsService = (function () {
    function VPrismjsService() { }

    /** 获取Prism对象
     *
     *
     * @returns {*}
     * @memberof VPrismjsService
     */
    VPrismjsService.prototype.getPrism = function () {
        return Prism;
    };
     ...
     *
     *
     * @param {string} code 要高亮的内容
     * @param {string} language 指定解析的语言
     * @param {*} [grammar] 语法。可不传。不传时，将自动根据指定解析的语言作为关键字，使用相应的语法
     * @returns {string} 经过处理后的内容
     * @memberof VPrismjsService
     */
    VPrismjsService.prototype.highlight = function (code, language, grammar) {
        if (!grammar) {
     ...
     * @memberof VPrismjsService
     */
    VPrismjsService.prototype.highlightAll = function (async, callback) {
     ...
     * @memberof VPrismjsService
     */
    VPrismjsService.prototype.highlightAllUnder = function (container, async, callback) {
     ...
     * @memberof VPrismjsService
     */
    VPrismjsService.prototype.highlightElement = function (element, async, callback) {
        Prism.highlightElement(element, async, callback);
    };

    return VPrismjsService;
}());
